	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="description" name="description" value="{{ old('description', $result->description) }}">
			</div>
			<div class="form-group">
				<label for="link">Liên kết</label>
				<input type="text" class="form-control" id="link" name="link" value="{{ old('link', $result->link) }}">
			</div>
			<div class="form-group" id="avatar">
				<label for="image">Ảnh đại diện</label>
				<input type="text" class="form-control" id="image" name="image" value="{{ URL::asset(old('image', $result->image) ) }}">
				<p style="margin-top:20px">
					<img src="{{ URL::asset(old('image', $result->image) ) }}" class="img-thumbnail" style="margin-right:20px; height:95px">
