...
@section('content')
				...
				<div id="home" class="tab-pane fade in active">
					<div class="panel-body">
						...
						<div class="form-group" id="imgAvatar">
							...
							<input name="image" type="text" id="image" class="form-control" value="" onblur="$(this).parents('#imgAvatar').find('img').attr('src', $(this).val());">
						...
						<div class="form-group">
							...
							<textarea name="information" id="information" class="form-control" cols="30" rows="10"></textarea>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
    	...
    	function addImage()
    	{
			...
			html += "</td>";
			html +=	"<td>";
			html +=	"	<button type=\"button\" class=\"btn btn-info\" onclick=\"$('#upload').modal('show'); value_element = '#slideshow" + number + "'\">Sửa<\/button>";
